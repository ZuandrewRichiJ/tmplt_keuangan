        ...
        <ul class="nav navbar-nav pull-right">
          ...
          <li class="nav-item dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-arrow profile-dropdown " aria-labelledby="Preview">
              ...
              <!-- item-->
              <a href="index.php?Page=Profil&&Id=1" class="dropdown-item notify-item">
          ...
          if (isset($_GET['Page'])) {
            ...
            switch ($Page) {
              ...
              case 'Pemasukan':
                ...
                break;
              case 'PemasukanAdd':
                include "pemasukan_add.php";
                break;
              case 'PemasukanUpdate':
                include "pemasukan_update.php";
                break;
              ...
              case 'PengeluaranAdd':
                ...
                break;
              case 'PengeluaranUpdate':
                include "pengeluaran_update.php";
                break;
