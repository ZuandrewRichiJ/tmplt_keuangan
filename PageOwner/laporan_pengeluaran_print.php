...
class FPDF_AutoWrapTable extends FPDF
{
  ...
  public function rptDetailData()
  {
    ...
    $this->SetX($left += 120); $this->Cell(280, $h, 'Keterangan', 1, 0, 'C', true);
    $this->SetX($left += 280); $this->Cell(100, $h, 'Nominal', 1, 0, 'C', true);
    $this->Ln(20);

    $this->SetFont('Arial', '', 10);
    $this->SetWidths(array(25, 120, 280, 100));
    ...
    $this->SetX($left += 425);
    $this->Cell(100, $h, ' ' . number_format($a, 0, ",", "."), 1, 0, 'L', true);
  }
